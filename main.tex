...
\subsection{Current state of the system} [ALEKXANDER AND FREDERIK]
\subsection{Licenses and compatibility}[ALBERT AND RASMUS]

\section{Process perspective}
\subsection{Interactions between as developers} [RASMUS & ALBERT]
\subsection{Team organization} [RASMUS & ALBERT]
\subsection{Description of CI/CD chains, stages and tools}[ALEKXANDER & FREDERIK]
